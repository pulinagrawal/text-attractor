...
from custom_modules import BasicSensoryMemory, BasicSensoryMotorMemory, TextAttractorCSM, TextAttractorProceduralMemory, TextAttractorEnvironment
...
if __name__ == '__main__':
    ...
    try:
        ...
        starter.add_module(TextAttractorCSM)
